    ...
    <main class="bg-black">
        ...
        <section>
            <RoboticsContainer class="space-y-6 py-16 lg:max-w-6/10">
                ...
                <p class="font-bold text-secondary">
                    <span class="text-active-green">•</span> Investigate a site for the presence of life by
        ...
        <section>
            <RoboticsContainer class="space-y-6 py-16 lg:max-w-6/10">
                ...
                <p class="font-bold text-secondary">
                    <span class="text-active-green">•</span> The rover, assisted by a drone, must deliver a
                ...
                <p class="text-secondary">
                    ...
                    delivers it to a cache. Once this has been completed, it picks up wreckage pieces and
        ...
        <section>
            <RoboticsContainer class="space-y-6 py-16 lg:max-w-6/10">
                ...
                <p class="font-bold text-secondary">
                    <span class="text-active-green">•</span> Perform dexterous operations using a robotic arm on
        ...
        <section>
            <RoboticsContainer class="space-y-6 py-16 lg:max-w-6/10">
                ...
                <p class="font-bold text-secondary">
                    <span class="text-active-green">•</span> Autonomously travel to a series of locations and
                    find objects.
                </p>
                <p class="text-secondary">
